...
class Decoder(nn.Module):
    def __init__(self, 
        ...
        self.tok_embedding = nn.Embedding(output_dim+3, hid_dim).cuda()
        self.pos_embedding = nn.Embedding(max_length, hid_dim).cuda()
    ...
    def forward(self, trg, enc_src, trg_mask, src_mask):
        ...
        #print(trg.device)
        x=self.dropout(self.tok_embedding(trg))
        #print(x.device)
...
class Seq2Seq(nn.Module):
    ...
    def forward(self, src, trg, is_train):
