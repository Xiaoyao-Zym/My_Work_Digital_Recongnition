...
class DRNet_V1_FeatureExtractor(nn.Module):
    def __init__(self,  imgH, input_channel):
        """
        :param imgH: 图片高度
        :param nc: 图片通道数
        :param nclass: 类别个数
        ...
        super(DRNet_V1_FeatureExtractor, self).__init__()
        assert imgH % 16 == 0, '图片高度必须是16的倍数，建议32'
        
        self.conv1 = nn.Conv2d(in_channels=input_channel, out_channels=8, kernel_size=3, stride=1, padding=1, bias=False)
