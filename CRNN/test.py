...
def parse_opt():
    ...
    parser.add_argument('--weights', type=str, default='log/output/checkpoint/2022-08-25-020_2.14_0.85.pt', help='权重的路径')
    parser.add_argument('--batch_size', type=int, default=64, help='批次大小')
    parser.add_argument('--all', action='store_true', default=False)
    parser.add_argument('--chinese', type=str, default='./labels/figure.txt', help='字符集保存路径')
    parser.add_argument('--images', type=str, default='../data/image/', help='图片路径，同train.py的参数一样')
    parser.add_argument('--labels', type=str, default='./labels/', help='标签路径')
